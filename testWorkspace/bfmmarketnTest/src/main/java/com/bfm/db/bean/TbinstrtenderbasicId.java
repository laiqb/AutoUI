...
/**
 * TbinstrtenderbasicId generated by hbm2java
 */
public class TbinstrtenderbasicId implements java.io.Serializable {

	private String dailyInstructionNo;
	private BigDecimal indexDailyModify;

	public TbinstrtenderbasicId() {
	}

	public TbinstrtenderbasicId(String dailyInstructionNo,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TbinstrtenderbasicId))
			return false;
		TbinstrtenderbasicId castOther = (TbinstrtenderbasicId) other;
