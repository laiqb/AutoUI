...
/**
 * TbinstrateId generated by hbm2java
 */
public class TbinstrateId implements java.io.Serializable {
	...
	public TbinstrateId(String businNo, BigDecimal legNo, BigDecimal versionNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TbinstrateId))
			return false;
		TbinstrateId castOther = (TbinstrateId) other;
